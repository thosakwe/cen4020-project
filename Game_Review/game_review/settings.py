...
# Adding paths for video playback
...
SECRET_KEY = '*_xuhtm$d2n88(8t2d8!ws6wr21vt1etsiac9db_ej&61xs*u!'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'VideoGameReview'),
    }
}
...
# Django defaults the login route as 'accounts/login'
# I only used 'login'. This can be swapped out later on
LOGIN_URL = 'login'
